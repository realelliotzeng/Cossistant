...
Both entrypoints share the same widget theme behavior, and both will automatically pick up common shadcn-style host tokens like `--background`, `--primary`, `--radius`, and `--font-sans` when they exist.
